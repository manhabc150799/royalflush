...
/**
 * Optimized NetworkService with auto-reconnect, packet queuing, and connection
 * management.
...
public class NetworkService {
     ...
     * This is called automatically by Autumn MVC after all components are
     * initialized
     */
    @Initiate
        ...
        new Thread(() -> {
            try {
                ...
                if (reconnectAttempts.incrementAndGet() < MAX_RECONNECT_ATTEMPTS) {
                    ...
                    logger.error("Max reconnect attempts ({}) reached. Please check if server is running.",
