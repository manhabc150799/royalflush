...
public class LoginController implements ViewRenderer {
    ...
    private void setupUI() {
        ...
        // Layer 2: Interactive UI Forms (overlay will be added as background to forms container)
        createForms();
    }
    ...
    private void handleRegister() {
        ...
        // Send request - NetworkService will queue it if not connected yet
        // This ensures the user data is saved to database when connection is established
        ...
        networkService.addListener(new PacketListener() {
            ...
            public void onConnected() {
                Gdx.app.postRunnable(() -> {
                    ...
                    if (registerErrorLabel != null && registerErrorLabel.getText().toString().contains("Not connected")) {
                        hideRegisterError();
                    }
                });
            }
